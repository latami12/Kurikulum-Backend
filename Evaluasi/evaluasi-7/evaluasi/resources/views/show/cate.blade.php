            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="/category/Eredivise">Eredivise</a>
                        <a class="dropdown-item" href="/category/La Liga">La Liga</a>
                        <a class="dropdown-item" href="/category/Ligue 1">Ligue 1</a>
                        <a class="dropdown-item" href="/category/Seria A">Seria A</a>
                        <a class="dropdown-item" href="/category/Timnas">Timnas</a>
                    </div>
                </li>
            </ul>
