  ...
  <div class="w3-content" style="max-width:1400px">
    ...
    <body>
      <div class="box shadow-lg">
        ...
        <form action="<?= BASEURL ; ?>/Admin1/login" method="post">
          <label for="username">username</label>
          <input type="text" name="username" id="username" class="form_login" placeholder="email...">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action=" <?= BASEURL;?>/Admin1/signup" method="post">
